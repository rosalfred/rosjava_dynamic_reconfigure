 ...
 */
public class DynamicReconfigureException extends RuntimeException {

    public DynamicReconfigureException(String msg) {
        super(msg);
    }

    /**  Serial Version Unique ID for serialization. */
    private static final long serialVersionUID = 3990242478670133583L;
