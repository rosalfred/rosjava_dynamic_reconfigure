 ...
 */
public class DynamicReconfigureCallbackException extends
        DynamicReconfigureException {

    public DynamicReconfigureCallbackException(String msg) {
        super(msg);
    }

    /**  Serial Version Unique ID for serialization. */
    private static final long serialVersionUID = -3569687606966005885L;
